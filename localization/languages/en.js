...
export default {
  ...
  descPlaceholder: 'Explain why you believe the fine should be canceled or reduced. Include any relevant circumstances, evidence, or legal arguments that support your case...',
  ...
  descriptionOfIncidentPlaceholder: 'Explain why you believe the fine should be canceled or reduced. Include any relevant circumstances, evidence, or legal arguments that support your case...',
  ...
  actionDateTime: 'Date and Time of the Violation',
  actionDateTimeRequired: 'Date and time of the violation is required',
  selectDateAndTime: 'Select date and time',
  offenseClauses: 'Offense clauses appearing in the report',
  offenseClausesPlaceholder: 'Enter the regulation clauses mentioned in the fine',
  offenseClausesRequired: 'Offense clauses are required',
  factualDescription: 'Quoted factual description from the report',
  factualDescriptionPlaceholder: 'Enter the exact wording of how the officer described the violation in the report',
  factualDescriptionRequired: 'Factual description is required',
